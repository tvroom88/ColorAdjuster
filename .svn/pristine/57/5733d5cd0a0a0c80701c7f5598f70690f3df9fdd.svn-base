...
public class BlueRowPanel extends JPanel implements PropertyChangeListener {
    ...
    private void addListeners() {
        ...
        myIncreaseButton.addActionListener(new IncrementBlueColorComponent());
        myDecreaseButton.addActionListener(new DecrementBlueColorComponent());
    ...
    private void getTextFieldNumber() {
        ...
        if (myValueField.isEditable()) {
            String inStringOfBlue = myValueField.getText().trim();
            if (inStringOfBlue.length() != 0 && isDigit(inStringOfBlue)) {
                int inIntegerOfBlue = Integer.parseInt(inStringOfBlue);
                if (inIntegerOfBlue >= 0 && inIntegerOfBlue <= 255) {
                    myColor.setBlue(inIntegerOfBlue);
                }
            }
        }
        myValueField.setText(String.valueOf(myColor.getBlue()));
    ...
    private class IncrementBlueColorComponent implements ActionListener{
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            if(myColor.getBlue() < 255) myColor.adjustBlue(1);
    ...
    private class DecrementBlueColorComponent implements ActionListener{
        ...
        public void actionPerformed(final ActionEvent e) {
            ...
            if(myColor.getBlue() > 0) myColor.adjustBlue(-1);
