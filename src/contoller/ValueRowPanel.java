...
public class ValueRowPanel extends JPanel implements PropertyChangeListener {
     ...
     */
    public ValueRowPanel(final PropertyChangeEnabledMutableColor theColor, final int panelNum) {
        super();
        myColor = theColor;
    ...
    private void layoutComponents() {
        ...
        if(panelNum == 1) {
            ...
            JLabel rowLabel = new JLabel("Red: ");
            ...
            JLabel rowLabel = new JLabel("Green: ");
            ...
            JLabel rowLabel = new JLabel("Blue: ");
...
//        myColorDisplayPanel.setBackground(new Color(0, 0, myColor.getBlue()));
    ...
    private void getTextFieldNumber() {
        ...
        if (myValueField.isEditable()) {
            String inColorText = myValueField.getText().trim();
            if (inColorText.length() != 0 && isDigit(inColorText)) {
                int inColoInteger = Integer.parseInt(inColorText);
                if (inColoInteger >= 0 && inColoInteger <= 255) {
                    
                    
                    if(panelNum == 1) {
                        myColor.setRed(inColoInteger);
                    }else if(panelNum == 2) {
                        myColor.setGreen(inColoInteger);
                    }else if(panelNum == 3) {
                        myColor.setBlue(inColoInteger);
                    }
                }
            }
        }
